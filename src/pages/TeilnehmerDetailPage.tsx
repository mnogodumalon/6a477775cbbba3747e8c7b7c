...
export default function TeilnehmerDetailPage() {
  ...
  const [record, setRecord] = useState<Teilnehmer | null>(null);
  ...
  async function handleDelete() {
    if (!record) return;
    await LivingAppsService.deleteTeilnehmerEntry(record.record_id);
    setDeleteOpen(false);
    navigate('/teilnehmer');
  }
  ...
  return (
    ...
    >
      <RecordHeader title={record.fields.teilnehmer_vorname ?? 'Teilnehmer'} />
      ...
      <RecordSection title="Details" cols={2}>
        ...
        <RecordField label="Teilnehmer Vorname" value={record.fields.teilnehmer_vorname} format="text" />
        <RecordField label="Teilnehmer Nachname" value={record.fields.teilnehmer_nachname} format="text" />
        <RecordField label="Teilnehmer E-Mail" value={record.fields.teilnehmer_email} format="email" />
        <RecordField label="Teilnehmer Telefon" value={record.fields.teilnehmer_telefon} format="text" />
        <RecordField label="Zertifikats-Nr." value={record.fields.zertifikats_nr} format="text" />
        <RecordField label="Gebuchte Stufe" value={record.fields.gebuchte_stufe} format="pill" />
        <RecordField label="Gebuchtes Verfahren" value={record.fields.gebuchtes_verfahren} format="pill" />
        <RecordField label="Teilnehmerstatus" value={record.fields.teilnehmerstatus} format="text" />
