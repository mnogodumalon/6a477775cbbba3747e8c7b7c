...
const PROXY_BASE = '';
const APP_ID = '6a47773b26185019573688ad';
      ...
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="art"><SelectValue placeholder="" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={0}
              placeholder=""
              value={fields.max_teilnehmerzahl ?? ''}
              onChange={e => { const n = e.target.value ? Math.max(0, Number(e.target.value)) : undefined; setFields(f => ({ ...f, max_teilnehmerzahl: n })); }}
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              min={0}
              placeholder=""
              value={fields.aktuelle_teilnehmerzahl ?? ''}
              onChange={e => { const n = e.target.value ? Math.max(0, Number(e.target.value)) : undefined; setFields(f => ({ ...f, aktuelle_teilnehmerzahl: n })); }}
            />
          </div>
          <div className="space-y-2">
